...
- [Neovim](https://neovim.io): I have recently started using it again for creating a basic Rust development environment for learning purposes, which I mentioned [rust](/thoughts/rust) LazyVim is my distribution of choice currently.
